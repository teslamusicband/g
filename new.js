...
:root {
  ...
  /* Spacing raw (strict 8-pt grid) */
  --sp-1:8px; --sp-2:8px; --sp-3:8px; --sp-4:16px;
  --sp-5:16px; --sp-6:24px; --sp-7:24px; --sp-8:32px;
...
:root {
  ...
  /* Layout — 16-column grid: sidebar=4col, content=12col, gutter=24px */
  --grid-columns:  16;
  --grid-gutter:   24px;
  --sidebar-w:     272px;  /* 4 cols: (1440 - 15*24) / 16 * 4 + 3*24 = 272 */
  --sidebar-w-sm:  64px;
  --topbar-h:      64px;
  --content-max:   1168px; /* 12 cols: 1440 - 272 = 1168 */
  --content-col:   12;
  --content-gutter: 24px;
}
...
/* Sidebar — 4 columns of 16-col grid */
.sidebar{
...
.sidebar-logo-icon{width:40px;height:40px;background:var(--color-primary-light);
...
.sidebar-toggle{
  margin:var(--s1) var(--s2);background:var(--color-sidebar-hover);border:none;
...
.sidebar-nav{flex:1;overflow-y:auto;padding:var(--s1) 0}
.sidebar-section{padding:var(--s2) var(--s2) var(--s1);
...
.nav-item{display:flex;align-items:center;gap:var(--s2);
  padding:var(--s1) var(--s2);color:var(--color-sidebar-text);
  cursor:pointer;border-radius:var(--r-md);margin:0 var(--s1);
...
/* Main area — 12 columns of 16-col grid */
...
.topbar-search{display:flex;align-items:center;gap:var(--s1);
  background:var(--color-surface-alt);border:1px solid var(--color-border);
  border-radius:var(--r-full);padding:0 var(--s2);height:40px;
...
.topbar-badge{position:absolute;top:8px;right:8px;width:8px;height:8px;
  background:var(--color-status-err);border-radius:50%;border:2px solid #fff}
.topbar-avatar{width:40px;height:40px;border-radius:50%;
...
/* Page content — internal 12-column sub-grid */
...
/* Image placeholder — gray rectangle stub per spec */
.img-box{background:var(--prim-gray-200);border-radius:var(--card-img-radius);
  display:flex;flex-direction:column;align-items:center;justify-content:center;
  color:var(--prim-gray-400);font-size:var(--fz-sm);font-family:var(--font-body);
  gap:var(--s1);border:1px solid var(--prim-gray-300);position:relative;
  overflow:hidden;flex-shrink:0}
.img-box-emoji{font-size:24px;line-height:1;opacity:.6}
.img-box-label{font-size:var(--fz-xs);opacity:.5;text-align:center;padding:0 var(--s1)}

/* Buttons */
.btn{display:inline-flex;align-items:center;justify-content:center;
  gap:var(--s1);height:var(--btn-h);padding:0 var(--btn-px);
...
/* Inputs */
.input-wrap{display:flex;flex-direction:column;gap:var(--s1)}
...
.input{height:var(--input-h);background:var(--input-bg);border:1.5px solid var(--input-border);
  border-radius:var(--input-radius);padding:0 var(--input-px);
  font-size:var(--input-fz);font-family:var(--font-body);color:var(--color-text);
  width:100%;display:flex;align-items:center;gap:var(--s1)}
...
.select-arrow{position:absolute;right:16px;top:50%;transform:translateY(-50%);
  color:var(--color-text-muted);pointer-events:none}

/* Badges & chips */
.badge{display:inline-flex;align-items:center;gap:8px;
  padding:0 8px;height:24px;border-radius:var(--r-full);font-size:var(--fz-xs);font-weight:600}
...
.chip{display:inline-flex;align-items:center;gap:8px;
  padding:0 16px;height:32px;border-radius:var(--r-full);font-size:var(--fz-sm);
...
/* Stars */
.stars{display:inline-flex;align-items:center;gap:0;color:#f59e0b}
.stars-count{font-size:var(--fz-sm);color:var(--color-text-2);margin-left:8px}

/* Counter stepper */
.counter{display:flex;align-items:center;border:1.5px solid var(--color-border);
  border-radius:var(--r-md);overflow:hidden;height:40px}
.counter-btn{width:40px;height:100%;display:flex;align-items:center;
...
.counter-val{min-width:40px;text-align:center;font-size:var(--fz-base);
  font-weight:600;padding:0 var(--s1)}
...
.col-2{display:grid;grid-template-columns:repeat(2,1fr);gap:var(--s3)}
.col-3{display:grid;grid-template-columns:repeat(3,1fr);gap:var(--s3)}
.col-4{display:grid;grid-template-columns:repeat(4,1fr);gap:var(--s3)}
.col-6{display:grid;grid-template-columns:repeat(6,1fr);gap:var(--s2)}
...
.auth-brand-tag{background:rgba(255,255,255,.1);color:var(--color-sidebar-text);
  border-radius:var(--r-full);padding:0 16px;height:32px;display:inline-flex;align-items:center;font-size:var(--fz-sm)}
.auth-form-side{display:flex;flex-direction:column;align-items:center;
  justify-content:center;padding:var(--s8)}
.auth-form-box{width:100%;max-width:424px}
.auth-form-title{font-family:var(--font-display);font-size:var(--text-h2);
  font-weight:700;margin-bottom:var(--s1);color:var(--color-text)}
...
.banner-label{font-size:var(--fz-sm);background:var(--color-accent);
  color:#fff;padding:0 16px;height:24px;line-height:24px;border-radius:var(--r-full);
...
.banner-dots{display:flex;gap:8px;margin-top:var(--s2)}
.banner-dot{width:8px;height:8px;border-radius:50%;
  background:rgba(255,255,255,.5)}
.banner-dot.active{background:#fff;width:24px}

/* ── CATEGORY GRID ───────────────────────────────────────────────── */
.cat-item{display:flex;flex-direction:column;align-items:center;gap:var(--s1);
...
.cat-icon{width:48px;height:48px;border-radius:var(--r-lg);
...
.product-card-fav{position:absolute;top:8px;right:8px;width:32px;height:32px;
  background:rgba(255,255,255,.85);border-radius:50%;display:flex;
  align-items:center;justify-content:center;color:var(--color-text-2);cursor:pointer;z-index:2}
.product-card-body{padding:var(--s2);flex:1;display:flex;flex-direction:column;gap:var(--s1)}
...
.product-card-meta{display:flex;align-items:center;gap:var(--s1);
  flex-wrap:wrap}
...
.product-card-footer{padding:var(--s1) var(--s2) var(--s2);margin-top:auto}
...
.farm-card-body{padding:var(--s2);display:flex;flex-direction:column;gap:var(--s1);flex:1}
...
.farm-card-meta{display:flex;gap:var(--s1);flex-wrap:wrap}
...
.miles-info{flex:1}
.miles-title{font-family:var(--font-display);font-size:var(--fz-xl);font-weight:700;margin-bottom:var(--s1)}
.miles-desc{font-size:var(--fz-sm);opacity:.85;line-height:1.5}
.miles-tags{display:flex;gap:var(--s1);flex-wrap:wrap;margin-top:var(--s2)}
.miles-tag{background:rgba(255,255,255,.15);border-radius:var(--r-full);
  padding:0 16px;height:24px;display:inline-flex;align-items:center;font-size:var(--fz-xs)}
...
.filter-chips{display:flex;flex-wrap:wrap;gap:var(--s1)}
.filter-range{display:flex;gap:var(--s1)}
...
.order-row-date{font-size:var(--fz-xs);color:var(--color-text-muted);margin-top:0}
...
.tour-card-date{font-size:var(--fz-xs);color:var(--color-text-2);margin-bottom:0}
.tour-card-name{font-size:var(--fz-base);font-weight:700;margin-bottom:var(--s1)}
...
.group-card-goal{font-size:var(--fz-sm);color:var(--color-text-2);margin-bottom:var(--s1)}
...
.stat-card-icon{font-size:32px;margin-bottom:var(--s1)}
.stat-card-val{font-family:var(--font-display);font-size:var(--fz-5xl);
  font-weight:700;color:var(--color-primary);line-height:1}
.stat-card-unit{font-size:var(--fz-sm);color:var(--color-text-2);margin-top:0}
.stat-card-label{font-size:var(--fz-xs);color:var(--color-text-muted);margin-top:var(--s1)}
...
.onboard-dots{display:flex;justify-content:center;gap:var(--s1);margin-top:var(--s4)}
.onboard-dot{width:8px;height:8px;border-radius:50%;background:var(--color-border)}
.onboard-dot.active{background:var(--color-primary);width:24px;border-radius:var(--r-full)}
...
.combined-screen-id{font-size:var(--fz-xs);color:var(--prim-gray-500);margin-top:0}

/* ── CHECKBOX (atom) ─────────────────────────────────────────────── */
.checkbox{display:inline-flex;align-items:center;gap:var(--s1);cursor:pointer;font-size:var(--fz-base)}
.checkbox-box{width:24px;height:24px;border:2px solid var(--color-border);border-radius:var(--r-sm);
  display:flex;align-items:center;justify-content:center;flex-shrink:0;background:var(--color-surface);transition:all .15s}
.checkbox.checked .checkbox-box{background:var(--color-primary);border-color:var(--color-primary);color:#fff}
.checkbox-label{font-size:var(--fz-base);color:var(--color-text)}

/* ── TOGGLE SWITCH (atom) ───────────────────────────────────────── */
.toggle{width:48px;height:24px;border-radius:var(--r-full);cursor:pointer;position:relative;
...
.toggle-knob{width:16px;height:16px;border-radius:50%;background:#fff;position:absolute;
  top:4px;transition:left .2s}
.toggle.off .toggle-knob{left:4px}
.toggle.on .toggle-knob{left:28px}
...
function checkbox(label, checked = false) {
  return `<label class="checkbox${checked ? ' checked' : ''}">
    <div class="checkbox-box">${checked ? I.check : ''}</div>
...
function toggle(on = false) {
  return `<div class="toggle ${on ? 'on' : 'off'}"><div class="toggle-knob"></div></div>`;
}
...
function infoRow(label, value) {
  return `<div style="display:flex;align-items:flex-start;gap:16px;padding:8px 0;border-bottom:1px solid var(--color-border)">
    <div style="min-width:160px;font-size:var(--fz-sm);color:var(--color-text-2)">${label}</div>
    <div style="font-size:var(--fz-base);font-weight:500">${value}</div>
  </div>`;
}
...
// Product card (organism: img-placeholder + badge + stars + button)
...
function basketCard({ name, items, price, emoji='🧺', href='subscriptions.html' }) {
  return `<div class="card card-p" style="border:1.5px solid var(--color-border)">
    <div style="display:flex;gap:16px;align-items:flex-start">
      ...
      <div style="flex:1">
        <div style="font-weight:700;font-size:var(--fz-md)">${name}</div>
        <div style="font-size:var(--fz-sm);color:var(--color-text-2);margin:8px 0">${items}</div>
        <div style="font-size:var(--fz-xl);font-weight:700;color:var(--color-primary)">${price} ₽</div>
      </div>
    </div>
...
function cartItem({ name, farm, price, emoji='🥦', qty=2 }) {
  return `<div style="display:flex;gap:16px;align-items:center;padding:16px;border-bottom:1px solid var(--color-border)">
    ${imgBox('64px','64px', emoji, '')}
    <div style="flex:1">
      <div style="font-weight:600">${name}</div>
      <div style="font-size:var(--fz-sm);color:var(--color-text-2);margin-top:0">${E.tractor} ${farm}</div>
    </div>
    ${counter(qty)}
    <div style="min-width:96px;text-align:right;font-weight:700;font-size:var(--fz-lg)">${price * qty} ₽</div>
  ...
  <div style="display:flex;gap:48px;align-items:flex-start">
    ...
    <div style="flex:1">
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:8px">
        ...
        <button style="background:none;border:none;cursor:pointer;color:var(--color-text-muted);padding:8px">${I.heart}</button>
      </div>
...
function pageFarmer() {
  ...
  <div style="display:flex;gap:32px;align-items:flex-start;margin-top:32px;margin-bottom:40px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;flex:0 0 264px">
    ...
    <div style="flex:0 0 280px;display:flex;flex-direction:column;gap:24px">
      ...
      <div class="filter-panel">
        ...
        <div style="padding:8px 0">
          ...
          ${progressBar(50)}
          <div style="display:flex;justify-content:space-between;font-size:11px;color:var(--color-text-muted);margin-top:8px">
...
function pageFarmMap() {
  ...
  <div style="display:flex;gap:24px">
    ...
    <div class="map-box" style="flex:1;height:560px;position:relative">
      ...
      ${pins.map(p => `
        <div class="map-pin" style="top:${p.top};left:${p.left}">
          <div style="background:var(--color-primary);color:#fff;border-radius:var(--r-full);padding:0 16px;height:24px;display:inline-flex;align-items:center;font-size:12px;font-weight:600;white-space:nowrap;box-shadow:var(--sh-md)">${p.emoji} ${p.label}</div>
          <div style="width:8px;height:8px;background:var(--color-primary);border-radius:50%;margin:0 auto"></div>
        </div>`).join('')}
      <div class="map-overlay">
        <div style="background:rgba(255,255,255,.9);border-radius:var(--r-full);padding:0 16px;height:24px;display:inline-flex;align-items:center;font-size:12px;color:var(--color-text-2)">
          📍 Вы здесь
        </div>
      </div>
    </div>
    ...
    <!-- Farms list -->
    <div style="flex:0 0 296px;display:flex;flex-direction:column;gap:16px;overflow-y:auto;max-height:560px">
      ${[
        ...
        <a href="farmer.html" class="card card-p" style="display:flex;gap:16px;text-decoration:none;color:inherit">
  ...
  <div style="display:flex;gap:32px;align-items:flex-start">
    ...
    <div style="flex:0 0 336px">
      <div class="card card-p" style="display:flex;flex-direction:column;gap:16px">
        ...
        <div style="font-size:12px;color:var(--color-text-2);background:var(--color-surface-2);border-radius:var(--r-md);padding:16px">
  ...
  <div style="display:flex;gap:32px;align-items:flex-start">
    <div style="flex:1;display:flex;flex-direction:column;gap:24px">
      ...
      <div class="card card-p">
        ...
        <div class="input" style="height:80px;align-items:flex-start;padding:16px">
...
function pagePayment() {
  ...
  <div style="max-width:480px;margin:0 auto;padding-top:40px">
    ...
    <div class="card card-p" style="display:flex;flex-direction:column;gap:24px">
      ...
      <div style="background:var(--color-surface-2);border-radius:var(--r-md);padding:16px;font-size:12px;color:var(--color-text-2);display:flex;gap:8px">
...
function pageOrderDetail() {
  ...
  <div style="display:flex;gap:32px;align-items:flex-start">
    ...
    <div style="flex:0 0 296px;display:flex;flex-direction:column;gap:16px">
      <div class="card card-p">
        <div style="font-weight:700;margin-bottom:16px">📍 Доставка</div>
        <div style="font-size:13px;color:var(--color-text-2)">г. Москва, ул. Садовая, д. 12, кв. 34</div>
        <div style="font-size:12px;color:var(--color-text-muted);margin-top:8px">25 мая · 12:00–16:00</div>
      </div>
      <div class="card card-p">
        <div style="font-weight:700;margin-bottom:16px">💰 Оплата</div>
        ${infoRow('Товары','870 ₽')}
        ${infoRow('Доставка','150 ₽')}
        <div style="display:flex;justify-content:space-between;padding-top:16px;font-weight:700">
...
function pageGroupBuys() {
  ...
  <div style="display:flex;gap:24px;margin-bottom:40px">
    ${[
      ...
      <div class="card card-p" style="flex:1;text-align:center">
        <div style="font-size:36px;margin-bottom:16px">${e}</div>
  ...
  <div class="card card-p" id="create">
    <div style="font-size:18px;font-weight:700;margin-bottom:24px">➕ Создать новую группу</div>
...
function pageProfile() {
  ...
  <div style="display:flex;gap:32px;align-items:flex-start">
    ...
    <!-- Avatar + nav -->
    <div style="flex:0 0 264px;display:flex;flex-direction:column;gap:8px">
    ...
    <div style="flex:1;display:flex;flex-direction:column;gap:24px">
      ...
      <div class="card">
        ...
        <div style="padding:16px">${btn('Все заказы', { variant:'ghost', href:'orders.html' })}</div>
      </div>
    </div>
  </div>
  `});
        ...
        <div class="card card-p">
          <div style="display:flex;gap:16px;align-items:flex-start;margin-bottom:16px">
            ...
            <div>
              ...
              <div style="font-size:12px;color:var(--color-text-2);margin-top:0">${s.items}</div>
              <div style="margin-top:8px;display:flex;gap:8px">
      ...
      <div class="card card-p">
        <div style="display:flex;align-items:flex-start;gap:16px">
          ...
          <div style="flex:1">
            ...
            <div style="font-size:13px;color:var(--color-text-2);margin-top:8px">${a.addr}</div>
          </div>
          <div style="display:flex;gap:8px">
  ...
  <div class="col-2">
    ...
    <div class="card card-p">
      ...
      ${[
        ...
        <div style="display:flex;align-items:center;gap:16px;padding:8px 0;border-bottom:1px solid var(--color-border)">
    ...
    <div class="card card-p">
      ...
      ${[
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 0;border-bottom:1px solid var(--color-border)">
          <span style="font-size:var(--fz-base)">${l}</span>
          ${toggle(on)}
        </div>`).join('')}
    </div>
  </div>
  ...
  <div style="max-width:900px;width:100%">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px">
      ${SCREENS.map((s,i) => `
        <a href="${s.id}.html" style="background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.1);
          ...
          transition:background .15s;display:flex;flex-direction:column;gap:8px"
    ...
    <div style="text-align:center;margin-top:32px">
      <a href="_combined.html" style="display:inline-flex;align-items:center;gap:8px;
        ...
        padding:0 32px;height:48px;display:inline-flex;align-items:center;font-weight:700;font-size:16px;text-decoration:none">
